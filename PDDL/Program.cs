...
namespace PDDL
{
    class Program
    {
        public static string BASE_PATH = @"C:\Users\oded1\OneDrive\Desktop\code\Offline";
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            List<Action> actionList = parsedDomain.Actions;
            State currentState = new State(parsedProblem);
