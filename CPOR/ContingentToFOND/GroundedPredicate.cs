...
namespace ContingentToFOND
{
    public class GroundedPredicate : Predicate
    {
        ...
        public static GroundedPredicate pFalsePredicate = new GroundedPredicate(Domain.FALSE_PREDICATE);
        public static GroundedPredicate pTruePredicate = new GroundedPredicate(Domain.TRUE_PREDICATE);
