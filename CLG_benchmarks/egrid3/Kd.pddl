...
(:action observe-lock-shapeT
 :parameters (?curpos - OBJ ?lockpos - OBJ ?shape - OBJ )
 :precondition 
(and (place ?curpos) (place ?lockpos) (shape ?shape) (conn ?curpos ?lockpos) (at-robot ?curpos) (NotKlock-shape ?lockpos ?shape))
 :effect 
(and (Klock-shape ?lockpos ?shape) (not (NotKlock-shape ?lockpos ?shape)))
)
(:action observe-lock-shapeF
 :parameters (?curpos - OBJ ?lockpos - OBJ ?shape - OBJ )
 :precondition 
(and (place ?curpos) (place ?lockpos) (shape ?shape) (conn ?curpos ?lockpos) (at-robot ?curpos) (NotKlock-shape ?lockpos ?shape))
 :effect 
(and (KNlock-shape ?lockpos ?shape) (not (NotKlock-shape ?lockpos ?shape)))
)
(:action unlock
...
(:action R8
:precondition (and(Klock-shape f1-0f shape0))
:effect (and(KNlock-shape f1-0f shape1)(not (NotKlock-shape f1-0f shape1)))
)
(:action R9
:precondition (and(KNlock-shape f1-0f shape1))
:effect (and(Klock-shape f1-0f shape0)(not (NotKlock-shape f1-0f shape0)))
)
(:action R10
:precondition (and(Klock-shape f1-0f shape1))
:effect (and(KNlock-shape f1-0f shape0)(not (NotKlock-shape f1-0f shape0)))
)
(:action R11
:precondition (and(KNlock-shape f1-0f shape0))
:effect (and(Klock-shape f1-0f shape1)(not (NotKlock-shape f1-0f shape1)))
)
(:action R12
:precondition (and(Klock-shape f0-1f shape0))
:effect (and(KNlock-shape f0-1f shape1)(not (NotKlock-shape f0-1f shape1)))
)
(:action R13
:precondition (and(KNlock-shape f0-1f shape1))
:effect (and(Klock-shape f0-1f shape0)(not (NotKlock-shape f0-1f shape0)))
)
(:action R14
:precondition (and(Klock-shape f0-1f shape1))
:effect (and(KNlock-shape f0-1f shape0)(not (NotKlock-shape f0-1f shape0)))
)
(:action R15
:precondition (and(KNlock-shape f0-1f shape0))
:effect (and(Klock-shape f0-1f shape1)(not (NotKlock-shape f0-1f shape1)))
)
)
