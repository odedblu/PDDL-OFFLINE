...
(:constants
 ...
 a3 - agent
 a4 - agent
 tag0 - TAG_TYPE ; (not (box-at b1 p3-1)) (box-at b1 p3-2) (not (box-at b0 p1-2)) (box-at b0 p1-1)
 tag1 - TAG_TYPE ; (box-at b1 p3-1) (not (box-at b1 p3-2)) (box-at b0 p1-2) (not (box-at b0 p1-1))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:precondition 
(and (adj ?start ?end) (agent-at ?a1 ?start) (agent-at ?a2 ?start) (box-at ?b ?start) (heavy ?b) (not (same-agent ?a1 ?a2)) (can-observe-not ?a2) (can-observe-not ?a1) (Kbox-at ?b ?start ?a1 V_TRUE) (Kbox-at ?b ?start ?a2 V_TRUE))
:effect 
...
:precondition 
(and (agent-at ?a1 ?i) (can-observe ?a1) (box-at ?b ?i) (not (Kbox-at ?b ?i ?a1 V_TRUE)) (not (Kbox-at ?b ?i ?a1 V_FALSE)))
:effect 
(and (Kbox-at ?b ?i ?a1 V_TRUE) (Observed ?a1))
)
(:action observe-box-F
:parameters ( ?a1 - agent ?i - pos ?b - box)
:precondition 
(and (agent-at ?a1 ?i) (can-observe ?a1) (not (box-at ?b ?i)) (not (Kbox-at ?b ?i ?a1 V_TRUE)) (not (Kbox-at ?b ?i ?a1 V_FALSE)))
:effect 
(and (Kbox-at ?b ?i ?a1 V_FALSE) (Observed ?a1))
)
(:action Merge-box-at
