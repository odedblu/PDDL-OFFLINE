...
(:action act-azv_observe-box-a1_p1-1_b0T
 :parameters (?a - agent )
 :precondition 
(and (not (Kbox-at b0 p1-1)) (not (KNbox-at b0 p1-1)) (init-azv_observe-box-a1_p1-1_b0 ) (immediate-dummy-azv_observe-box-a1_p1-1_b0 ) (agent-at a1 p1-1) (box-at b0 p1-1))
 :effect 
(and (Kbox-at b0 p1-1))
)
(:action act-azv_observe-box-a1_p1-1_b0F
 :parameters (?a - agent )
 :precondition 
(and (not (Kbox-at b0 p1-1)) (not (KNbox-at b0 p1-1)) (init-azv_observe-box-a1_p1-1_b0 ) (immediate-dummy-azv_observe-box-a1_p1-1_b0 ) (agent-at a1 p1-1) (not (box-at b0 p1-1)))
 :effect 
(and (KNbox-at b0 p1-1))
)
(:action act-dummy-azv_observe-box-a1_p1-1_b0
 :parameters (?a - agent )
 :precondition (init-azv_observe-box-a1_p1-1_b0 )
 :effect (immediate-dummy-azv_observe-box-a1_p1-1_b0 )
)
(:action dummy-left-azv_observe-box-a1_p1-1_b0
 :parameters (?a - agent )
 :precondition 
(and (init-azv_observe-box-a1_p1-1_b0 ) (agent-at a1 p1-1) (KNbox-at b0 p1-1) (immediate-dummy-azv_observe-box-a1_p1-1_b0 ))
 :effect 
(and (not (init-azv_observe-box-a1_p1-1_b0 )) (not (immediate-dummy-azv_observe-box-a1_p1-1_b0 )) (dummy-left-azv_observe-box-a1_p1-1_b0 ))
)
(:action dummy-right-azv_observe-box-a1_p1-1_b0
 :parameters (?a - agent )
 :precondition 
(and (init-azv_observe-box-a1_p1-1_b0 ) (agent-at a1 p1-1) (Kbox-at b0 p1-1) (immediate-dummy-azv_observe-box-a1_p1-1_b0 ))
 :effect 
(and (not (init-azv_observe-box-a1_p1-1_b0 )) (not (immediate-dummy-azv_observe-box-a1_p1-1_b0 )) (dummy-right-azv_observe-box-a1_p1-1_b0 ))
)
(:action goal-achieve-left-azv_observe-box-a1_p1-1_b0
 :parameters (?a - agent )
 :precondition 
(and (dummy-left-azv_observe-box-a1_p1-1_b0 ) (KNbox-at b0 p1-1))
 :effect (done-goal )
)
(:action act-3mv_push_p1-1_p1-2_b0_a1
 :parameters (?a - agent )
 :precondition 
(and (dummy-right-azv_observe-box-a1_p1-1_b0 ) (Kbox-at b0 p1-1) (agent-at a1 p1-1))
 :effect 
(and (pre-3mv_push_p1-1_p1-2_b0_a1 ) (KNbox-at b0 p1-1) (Kbox-at b0 p1-2))
)
(:action goal-achieve-3mv_push_p1-1_p1-2_b0_a1
 :parameters (?a - agent )
 :precondition (pre-3mv_push_p1-1_p1-2_b0_a1 )
 :effect (done-goal )
)
(:action R0
