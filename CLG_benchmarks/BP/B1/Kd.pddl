...
(:constants
 ...
 a2 - agent
 a3 - agent
 tag0 - TAG_TYPE ; (not (box-at b0 p1-2)) (box-at b0 p1-1) (not (box-at b1 p3-1)) (box-at b1 p3-2)
 tag1 - TAG_TYPE ; (box-at b0 p1-2) (not (box-at b0 p1-1)) (box-at b1 p3-1) (not (box-at b1 p3-2))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:effect 
(and (not (agent-at ?a ?start)) (agent-at ?a ?end) (not (box-at ?b ?start)) (box-at ?b ?end) (Kbox-at ?b ?start ?a V_FALSE) (not (Kbox-at ?b ?start ?a V_TRUE)) (Kbox-at ?b ?end ?a V_TRUE) (not (Kbox-at ?b ?end ?a V_FALSE)))
)
(:action joint-push
...
:precondition 
(and (agent-at ?a ?p) (box-at ?b ?p))
:effect (Kbox-at ?b ?p ?a V_TRUE)
)
(:action observe-box-F
:parameters ( ?p - pos ?a - agent ?b - box)
:precondition 
(and (agent-at ?a ?p) (not (box-at ?b ?p)))
:effect (Kbox-at ?b ?p ?a V_FALSE)
)
(:action Merge-box-at
