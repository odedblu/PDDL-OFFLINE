...
(:constants
 ...
 a2 - agent
 a3 - agent
 tag0 - TAG_TYPE ; (not (box-at b1 p2-1)) (box-at b1 p2-2) (box-at b2 p3-1) (not (box-at b2 p3-2)) (not (box-at b0 p1-1)) (box-at b0 p1-2)
 tag1 - TAG_TYPE ; (box-at b1 p2-1) (not (box-at b1 p2-2)) (not (box-at b2 p3-1)) (box-at b2 p3-2) (box-at b0 p1-1) (not (box-at b0 p1-2))
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:precondition 
(and (agent-at ?a ?i) (box-at ?b ?i))
:effect (Kbox-at ?b ?i ?a V_TRUE)
)
(:action observe-box-F
:parameters ( ?i - pos ?a - agent ?b - box)
:precondition 
(and (agent-at ?a ?i) (not (box-at ?b ?i)))
:effect (Kbox-at ?b ?i ?a V_FALSE)
)
(:action Merge-box-at
