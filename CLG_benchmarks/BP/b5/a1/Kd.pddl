...
(:action act-ykv_observe-box_p1-1_a1_b0T
 :parameters (?a - agent )
 :precondition 
(and (not (Kbox-at b0 p1-1)) (not (KNbox-at b0 p1-1)) (init-ykv_observe-box_p1-1_a1_b0 ) (immediate-dummy-ykv_observe-box_p1-1_a1_b0 ) (agent-at a1 p1-1) (box-at b0 p1-1))
 :effect 
(and (Kbox-at b0 p1-1))
)
(:action act-ykv_observe-box_p1-1_a1_b0F
 :parameters (?a - agent )
 :precondition 
(and (not (Kbox-at b0 p1-1)) (not (KNbox-at b0 p1-1)) (init-ykv_observe-box_p1-1_a1_b0 ) (immediate-dummy-ykv_observe-box_p1-1_a1_b0 ) (agent-at a1 p1-1) (not (box-at b0 p1-1)))
 :effect 
(and (KNbox-at b0 p1-1))
)
(:action act-dummy-ykv_observe-box_p1-1_a1_b0
 :parameters (?a - agent )
 :precondition (init-ykv_observe-box_p1-1_a1_b0 )
 :effect (immediate-dummy-ykv_observe-box_p1-1_a1_b0 )
)
(:action dummy-left-ykv_observe-box_p1-1_a1_b0
 :parameters (?a - agent )
 :precondition 
(and (init-ykv_observe-box_p1-1_a1_b0 ) (agent-at a1 p1-1) (KNbox-at b0 p1-1) (immediate-dummy-ykv_observe-box_p1-1_a1_b0 ))
 :effect 
(and (not (init-ykv_observe-box_p1-1_a1_b0 )) (not (immediate-dummy-ykv_observe-box_p1-1_a1_b0 )) (dummy-left-ykv_observe-box_p1-1_a1_b0 ))
)
(:action dummy-right-ykv_observe-box_p1-1_a1_b0
 :parameters (?a - agent )
 :precondition 
(and (init-ykv_observe-box_p1-1_a1_b0 ) (agent-at a1 p1-1) (Kbox-at b0 p1-1) (immediate-dummy-ykv_observe-box_p1-1_a1_b0 ))
 :effect 
(and (not (init-ykv_observe-box_p1-1_a1_b0 )) (not (immediate-dummy-ykv_observe-box_p1-1_a1_b0 )) (dummy-right-ykv_observe-box_p1-1_a1_b0 ))
)
(:action goal-achieve-left-ykv_observe-box_p1-1_a1_b0
 :parameters (?a - agent )
 :precondition 
(and (dummy-left-ykv_observe-box_p1-1_a1_b0 ) (KNbox-at b0 p1-1))
 :effect (done-goal )
)
(:action act-ci6_joint-push_p1-1_p1-2_b0_a1_a3
 :parameters (?a - agent )
 :precondition 
(and (dummy-right-ykv_observe-box_p1-1_a1_b0 ) (Kbox-at b0 p1-1) (agent-at a1 p1-1))
 :effect 
(and (pre-ci6_joint-push_p1-1_p1-2_b0_a1_a3 ) (KNbox-at b0 p1-1) (Kbox-at b0 p1-2))
)
(:action goal-achieve-ci6_joint-push_p1-1_p1-2_b0_a1_a3
 :parameters (?a - agent )
 :precondition (pre-ci6_joint-push_p1-1_p1-2_b0_a1_a3 )
 :effect (done-goal )
)
(:action R0
