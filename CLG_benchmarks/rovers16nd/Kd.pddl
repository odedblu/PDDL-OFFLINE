...
(:constants
 ...
 opt0 - OPTION_TYPE
 opt1 - OPTION_TYPE
 tag0 - TAG_TYPE ; (take_image_rover0_waypoint12_objective1_camera0_high_res_option_1 ) (option opt0) (not (option opt1))
 tag1 - TAG_TYPE ; (not (take_image_rover0_waypoint12_objective1_camera0_high_res_option_1 )) (not (option opt0)) (option opt1)
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
