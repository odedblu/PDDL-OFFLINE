...
(:action raise-antena
:effect (and (antena-height h1) (not (antena-height h0)))
)

(:action lower-antena
:effect (and (not (antena-height h1)) (antena-height h0))
)

(:action activate-sensor-at-p1-1-h1
:precondition (and (agent-at p1-1) (antena-height h1))
:effect (and (when (or (good r3)) (good-rocks-in-range )) (when (and (not (good r3))) (not (good-rocks-in-range ))))
)

(:action activate-sensor-at-p1-2-h1
:precondition (and (agent-at p1-2) (antena-height h1))
:effect (and (when (or (good r2)) (good-rocks-in-range )) (when (and (not (good r2))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r2) (good r5)) (good-rocks-in-range )) (when (and (not (good r2)) (not (good r5))) (not (good-rocks-in-range ))))
)

(:action activate-sensor-at-p1-5-h0
:precondition (and (agent-at p1-5) (antena-height h0))
:effect (and (when (or (good r5)) (good-rocks-in-range )) (when (and (not (good r5))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r1)) (good-rocks-in-range )) (when (and (not (good r1))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r9)) (good-rocks-in-range )) (when (and (not (good r9))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r6)) (good-rocks-in-range )) (when (and (not (good r6))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r8)) (good-rocks-in-range )) (when (and (not (good r8))) (not (good-rocks-in-range ))))
)

(:action activate-sensor-at-p5-2-h1
:precondition (and (agent-at p5-2) (antena-height h1))
:effect (and (when (or (good r7)) (good-rocks-in-range )) (when (and (not (good r7))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r11)) (good-rocks-in-range )) (when (and (not (good r11))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r4) (good r7) (good r8)) (good-rocks-in-range )) (when (and (not (good r4)) (not (good r7)) (not (good r8))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r7) (good r8)) (good-rocks-in-range )) (when (and (not (good r7)) (not (good r8))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r0)) (good-rocks-in-range )) (when (and (not (good r0))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r4)) (good-rocks-in-range )) (when (and (not (good r4))) (not (good-rocks-in-range ))))
)

(:action activate-sensor-at-p7-1-h1
:precondition (and (agent-at p7-1) (antena-height h1))
:effect (and (when (or (good r4) (good r8)) (good-rocks-in-range )) (when (and (not (good r4)) (not (good r8))) (not (good-rocks-in-range ))))
)

(:action activate-sensor-at-p7-2-h1
:precondition (and (agent-at p7-2) (antena-height h1))
:effect (and (when (or (good r4) (good r7)) (good-rocks-in-range )) (when (and (not (good r4)) (not (good r7))) (not (good-rocks-in-range ))))
)
...
:effect (and (when (or (good r10)) (good-rocks-in-range )) (when (and (not (good r10))) (not (good-rocks-in-range ))))
)
