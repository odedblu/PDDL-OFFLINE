...
(:constants
 ...
 opt0 - OPTION_TYPE
 opt1 - OPTION_TYPE
 tag0 - TAG_TYPE ; (get-egg_option_0 ) (not (get-egg_option_1 )) (get-egg_option_2 ) (get-egg_option_3 ) (get-egg_option_4 ) (get-egg_option_5 ) (get-egg_option_7 ) (get-egg_option_8 ) (get-egg_option_9 ) (get-egg_option_10 ) (get-egg_option_11 ) (get-egg_option_12 ) (get-egg_option_13 ) (not (get-egg_option_14 )) (option opt0) (not (option opt1))
 tag1 - TAG_TYPE ; (not (get-egg_option_0 )) (not (get-egg_option_2 )) (not (get-egg_option_3 )) (not (get-egg_option_4 )) (not (get-egg_option_5 )) (not (get-egg_option_7 )) (not (get-egg_option_8 )) (not (get-egg_option_9 )) (not (get-egg_option_10 )) (not (get-egg_option_11 )) (not (get-egg_option_12 )) (not (get-egg_option_13 )) (not (option opt0)) (option opt1) (get-egg_option_1 ) (get-egg_option_14 )
 V_TRUE - VALUE_TYPE
 V_FALSE - VALUE_TYPE
)
...
:parameters ( ?i - bowl)
:effect 
(and (good ?i) (not (eggs-in ?i v1)) (not (eggs-in ?i v2)) (not (eggs-in ?i v3)) (not (eggs-in ?i v4)) (not (eggs-in ?i v5)) (not (eggs-in ?i v6)) (not (eggs-in ?i v7)) (not (eggs-in ?i v8)) (eggs-in ?i v0) (Kgood ?i) (not (KNgood ?i)) (KGivengood ?i tag0 V_TRUE) (not (KGivengood ?i tag0 V_FALSE)) (KGivengood ?i tag1 V_TRUE) (not (KGivengood ?i tag1 V_FALSE)))
)
