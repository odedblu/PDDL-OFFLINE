...
(:action empty
	:parameters (?i - bowl)
	:effect (and (good ?i) (not (eggs-in ?i v1)) (not (eggs-in ?i v2)) (not (eggs-in ?i v3)) (not (eggs-in ?i v4)) (not (eggs-in ?i v5)) (not (eggs-in ?i v6)) (not (eggs-in ?i v7)) (not (eggs-in ?i v8)) (eggs-in ?i v0))
)
