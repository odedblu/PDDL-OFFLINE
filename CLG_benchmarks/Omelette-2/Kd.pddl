...
:parameters ( ?i - bowl)
:effect 
(and (good ?i) (not (eggs-in ?i v1)) (not (eggs-in ?i v2)) (eggs-in ?i v0) (Kgood ?i) (not (KNgood ?i)) (KGivengood ?i tag0 V_TRUE) (not (KGivengood ?i tag0 V_FALSE)) (KGivengood ?i tag1 V_TRUE) (not (KGivengood ?i tag1 V_FALSE)))
)
