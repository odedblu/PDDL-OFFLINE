...
(MOVE-DIR pos-09-09 pos-09-08 dir-up)
	(at player-01 pos-08-09)
		(oneof (at-stone stone-01 pos-09-08) (at-stone stone-01 pos-09-09))
	(oneof (at-stone stone-01 pos-09-08) (clear pos-09-08))
	(oneof (at-stone stone-01 pos-09-09) (clear pos-09-09))
	
	(oneof (at-stone stone-02 pos-01-02) (at-stone stone-02 pos-01-03))
	(oneof (at-stone stone-02 pos-01-02) (clear pos-01-02))
	(oneof (at-stone stone-02 pos-01-03) (clear pos-01-03))
	
		(oneof (at-stone stone-03 pos-04-05) (at-stone stone-03 pos-02-06))
	(oneof (at-stone stone-03 pos-04-05) (clear pos-04-05))
	(oneof (at-stone stone-03 pos-02-06) (clear pos-02-06))
	
	
;;	(at stone-03 pos-02-02)
...
;;(clear pos-09-09)
  ...
  (:goal (and
    (at-goal stone-02)(at-goal stone-01))
  )
)
