...
(:init    
		(oneof (pathSelected A1) (pathSelected A2) (pathSelected A3) (pathSelected A4) (pathSelected A5) (pathSelected A6) (pathSelected A7) (pathSelected A8) 
			(pathSelected A9) (pathSelected A10)) 
		...
		(D_launchFromX d4 n8) (D_launchFromY d4 n12) (D_launchFromZ d4 n2) 	
