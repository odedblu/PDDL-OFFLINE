...
(:action activate-sensor-at-p1-1-h0
:precondition (and (agent-at p1-1) (antena-height h0))
:effect (and
	(when (or  (good r14)) (good-rocks-in-range))
	(when (and  (not (good r14))) (not (good-rocks-in-range)))
))

(:action activate-sensor-at-p1-1-h1
:precondition (and (agent-at p1-1) (antena-height h1))
:effect (and
	(when (or  (good r3) (good r14)) (good-rocks-in-range))
	(when (and  (not (good r3)) (not (good r14))) (not (good-rocks-in-range)))
))

(:action activate-sensor-at-p1-2-h1
:precondition (and (agent-at p1-2) (antena-height h1))
:effect (and
	(when (or  (good r2) (good r14)) (good-rocks-in-range))
	(when (and  (not (good r2)) (not (good r14))) (not (good-rocks-in-range)))
))
...
:effect (and
	(when (or  (good r1) (good r15)) (good-rocks-in-range))
	(when (and  (not (good r1)) (not (good r15))) (not (good-rocks-in-range)))
))
...
:effect (and
	(when (or  (good r9) (good r15)) (good-rocks-in-range))
	(when (and  (not (good r9)) (not (good r15))) (not (good-rocks-in-range)))
))

(:action activate-sensor-at-p3-7-h0
:precondition (and (agent-at p3-7) (antena-height h0))
:effect (and
	(when (or  (good r15)) (good-rocks-in-range))
	(when (and  (not (good r15))) (not (good-rocks-in-range)))
))
...
(:action activate-sensor-at-p4-7-h1
:precondition (and (agent-at p4-7) (antena-height h1))
:effect (and
	(when (or  (good r15)) (good-rocks-in-range))
	(when (and  (not (good r15))) (not (good-rocks-in-range)))
))
