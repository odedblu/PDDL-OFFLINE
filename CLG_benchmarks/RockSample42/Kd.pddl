...
(:action raise-antena
:effect (and (when (antena-height h0) (and (not (antena-height h0)) (antena-height h1))) (when (antena-height h1) (and (not (antena-height h1)) (antena-height h2))))
)

(:action lower-antena
:effect (and (when (antena-height h1) (and (not (antena-height h1)) (antena-height h0))) (when (antena-height h2) (and (not (antena-height h2)) (antena-height h1))))
)
