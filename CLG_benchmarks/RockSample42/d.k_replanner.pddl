...
:effect 
(and (agent-at ?pTarget) (not (agent-at ?pSource)) (not (good-rocks-in-range )))
)

(:action sample
:parameters ( ?r - ROCK ?p - LOCATION)
:precondition 
(and (agent-at ?p) (rock-at ?r ?p) (good ?r))
:effect (not (good ?r))
)
...
:effect 
(and 
	(when (antena-height h0) 
		(and (not (antena-height h0)) (antena-height h1)))
	(when (antena-height h1) 
		(and (not (antena-height h1)) (antena-height h2))))
)
...
(and 
	...
	(when (antena-height h2) 
		(and (not (antena-height h2)) (antena-height h1))))
)

(:action activate-sensor-at-p1-2-h2
:precondition 
(and (agent-at p1-2) (antena-height h2))
:effect 
(and 
...
:precondition 
(and (agent-at p1-3) (antena-height h2))
:effect 
(and 
	(when (good r1) (good-rocks-in-range ))
	(when (not (good r1)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p1-4) (antena-height h2))
:effect 
(and 
	(when (good r1) (good-rocks-in-range ))
	(when (not (good r1)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p2-2) (antena-height h2))
:effect 
(and 
...
:precondition 
(and (agent-at p2-3) (antena-height h2))
:effect 
(and 
	(when (good r1) (good-rocks-in-range ))
	(when (not (good r1)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p2-4) (antena-height h2))
:effect 
(and 
	(when (good r1) (good-rocks-in-range ))
	(when (not (good r1)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p3-1) (antena-height h2))
:effect 
(and 
	(when (good r0) (good-rocks-in-range ))
	(when (not (good r0)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p3-2) (antena-height h2))
:effect 
(and 
	(when (good r0) (good-rocks-in-range ))
	(when (not (good r0)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p3-3) (antena-height h2))
:effect 
(and 
	(when (good r0) (good-rocks-in-range ))
	(when (not (good r0)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p3-4) (antena-height h2))
:effect 
(and 
	(when (good r1) (good-rocks-in-range ))
	(when (not (good r1)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p4-1) (antena-height h2))
:effect 
(and 
	(when (good r0) (good-rocks-in-range ))
	(when (not (good r0)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p4-2) (antena-height h2))
:effect 
(and 
	(when (good r0) (good-rocks-in-range ))
	(when (not (good r0)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p4-3) (antena-height h2))
:effect 
(and 
	(when (good r0) (good-rocks-in-range ))
	(when (not (good r0)) (not (good-rocks-in-range ))))
...
:precondition 
(and (agent-at p4-4) (antena-height h2))
:effect 
(and 
	(when (good r0) (good-rocks-in-range ))
	(when (not (good r0)) (not (good-rocks-in-range ))))
